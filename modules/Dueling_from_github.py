    ...
    for k in range(1000000):
        ...
        while not done:
            ...
            if t % update_interval == 0:
                ...
                torch.save(q.state_dict(), "checkpoints/dueling_from_github/mario_q.pth")
                torch.save(q_target.state_dict(), "checkpoints/dueling_from_github/mario_q_target.pth")
        ...
        if k % print_interval == 0:
            ...
            total_score = 0
            loss = 0.0
            pickle.dump(score_lst, open("checkpoints/dueling_from_github/score.p", "wb"))
